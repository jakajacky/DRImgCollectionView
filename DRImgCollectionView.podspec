...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "xqzh"
  # s.authors            = { "xqzh" => "xqzh@ideabinder.com" }
  # s.social_media_url   = "http://twitter.com/xqzh"
  ...
  s.source       = { :git => "https://github.com/jakajacky/DRImgCollectionView.git", :tag => "0.0.1" }
